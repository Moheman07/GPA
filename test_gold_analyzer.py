...
try:
    ...
    aiohttp = None
    print("⚠️ aiohttp not available - using synchronous requests")
...
try:
    ...
    TextBlob = None
    print("⚠️ TextBlob not available - news sentiment will be simulated")
...
class ProfessionalGoldAnalyzer:
    ...
    async def fetch_news_analysis(self):
        ...
        if not self.news_api_key or not aiohttp or not TextBlob:
